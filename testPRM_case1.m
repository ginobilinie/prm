...
function testPRM_case1()
workspace.xmin=0;workspace.xmax=22;workspace.ymin=0;workspace.ymax=22;
oblist(1).xmin=4;oblist(1).xmax=12;oblist(1).ymin=0;oblist(1).ymax=8;
...
ns=[5,10,20,30,40,50,100,150,200,300,400,500,500,600,700,800,900,1000,1200,1500];
m=5;%m is fixed here 
for i=1:length(ns);
    n=ns(i);
    sum=0;
...
figure();
plot(ns,c);
title('case-1: relationship between shortest path and and n');
xlabel('sampels : n');
ylabel('shortest path length');
saveas(gcf,'cost_case1.png');
save('cost_case1.mat','ns','c');
